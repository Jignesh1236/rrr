        ...
        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-green-50 p-4 rounded-lg">
              <p className="text-sm text-green-600 font-medium">Total Income (Services Only)</p>
            ...
            <div className="bg-teal-50 p-4 rounded-lg">
              <p className="text-sm text-teal-600 font-medium">Online Payment Total</p>
              <p className="text-2xl font-bold text-teal-700">₹{onlinePaymentTotal.toFixed(2)}</p>
            </div>
             <div className="bg-orange-50 p-4 rounded-lg">
              <p className="text-sm text-orange-600 font-medium">Cash Total</p>
              <p className="text-2xl font-bold text-orange-700">₹{cashTotal.toFixed(2)}</p>
            </div>
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-600 font-medium">Net Amount (All Sources)</p>
              <p className="text-2xl font-bold text-blue-700">₹{(incomeTotal + depositTotal + stampTotal + balanceTotal + mgvclTotal + onlinePaymentTotal + cashTotal - expencesTotal).toFixed(2)}</p>
            </div>
          </div>
