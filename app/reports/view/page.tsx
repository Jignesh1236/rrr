              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tbody>
                  ...
                  <tr style="background-color: #f0f0f0;">
                    ...
                    <td style="border: 1px solid #000; padding: 4px 8px; text-align: right; font-weight: bold;">${((report.totals?.income || 0) + (report.totals?.onlinePayment || 0) + (report.cash || 0) - (report.totals?.expences || 0)).toFixed(2)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        ...
                        <div className={`text-2xl font-bold ${((report.totals?.income || 0) - (report.totals?.expences || 0)) >= 0 ? 'text-green-300' : 'text-red-300'}`}>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="text-sm text-green-700 font-medium">INCOME (Services Only)</div>
