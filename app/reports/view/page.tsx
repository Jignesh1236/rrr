          ...
          <body>
            ...
            <div class="summary-box">
              <table style="width: 100%; border-collapse: collapse;">
                <tbody>
                  <tr>
                    <td style="border: 1px solid #000; padding: 4px 8px; font-weight: bold;">TOTAL:</td>
                    <td style="border: 1px solid #000; padding: 4px 8px; text-align: right; font-weight: bold;">${((report.totals?.income || 0) + (report.totals?.deposit || 0) + (report.totals?.stamp || 0) + (report.totals?.balance || 0) + (report.totals?.mgvcl || 0) + (report.totals?.onlinePayment || 0) + (report.cash || 0)).toFixed(2)}</td>
                  </tr>
                  <tr>
                    <td style="border: 1px solid #000; padding: 4px 8px; font-weight: bold;">GOOGLE PAY:</td>
                  ...
                  <tr>
                    <td style="border: 1px solid #000; padding: 4px 8px; font-weight: bold;">CASH (MANUAL):</td>
                    <td style="border: 1px solid #000; padding: 4px 8px; text-align: right; font-weight: bold;">${(report.cash || 0).toFixed(2)}</td>
                  </tr>
                  
                  <tr>
                    <td style="border: 1px solid #000; padding: 4px 8px; font-weight: bold;">EXPENCES:</td>
                  ...
                  <tr style="background-color: #f0f0f0;">
                    ...
                    <td style="border: 1px solid #000; padding: 4px 8px; text-align: right; font-weight: bold;">${netAmount.toFixed(2)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
